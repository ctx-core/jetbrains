...
export async function excludeFolder_a_() {
    const ideaexclude_path_a = await globby('**/.ideaexclude', { gitignore: true });
    ...
    await Promise.all(ideaexclude_path_a.map(async (ideaexclude_path) => {
...
//# sourceMappingURL=src/exclude_folder_a_.js.map